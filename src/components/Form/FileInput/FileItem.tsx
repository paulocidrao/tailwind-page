    ...
    <div className={container()}>
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button type="button" className="font-semibold text-error-700 text-sm hover:text-red-900 dark:text-error-400 dark:hover:text-error-300">
            Try again
          </button>
        </div>
      ) : (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-zinc-300 dark:text-zinc-400">{formatBytes(size)}</span>
          </div>
